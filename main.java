...
//        System.out.println(marketValue);
        ...
        switch (playerPos) {
            case 1:
                ...
                players.add(new Player("B", seven_cards[1], 0));
                players.add(new Player("C", seven_cards[2], 1));
                players.add(new Player("D", seven_cards[3], 2));
                break;
            case 2:
                players.add(new Player("A", seven_cards[0], 0));
            ...
            case 3:
                players.add(new Player("A", seven_cards[0], 0));
                players.add(new Player("B", seven_cards[1], 1));
            ...
            case 4:
                players.add(new Player("A", seven_cards[0], 0));
                players.add(new Player("B", seven_cards[1], 1));
                players.add(new Player("C", seven_cards[2], 2));
